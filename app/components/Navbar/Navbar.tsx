...
const navigation: NavigationItem[] = [
    { name: 'Quiero un carro', href: '#aboutus-section', current: false },
    { name: 'Quiero invertir', href: '#testimonial-section', current: false },
                            ...
                            <div className="flex flex-shrink-0 items-center border-right">
                                <Link href="/" className='text-2xl sm:text-4xl font-semibold text-black'>
                                   <Image
                                      src="/logo.png"
                                      alt="Pitaya logo"
                                      width={240} // ajusta el tamaño según tu diseño
                                      height={30}
